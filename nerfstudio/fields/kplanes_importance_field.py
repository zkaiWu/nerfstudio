...
class KPlanesImportanceField(Field):
    """K-Planes field.
    ...
    def __init__(
        ...
        assert linear_decoder == False, 'linear_decoder is not supported now'
        ...
        for res in multiscale_res:
            ...
            self.grids.append(KPlanesEncoding(resolution, grid_feature_dim, reduce=reduce))
        self.feature_dim = (
        ...
        if self.linear_decoder:
            ...
            if use_viewdirs:
                ...
                in_dim_color = (self.geo_feat_dim + self.appearance_embedding_dim)
