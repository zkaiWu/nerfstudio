...
@dataclass
class KPlanesImportanceModelConfig(ModelConfig):
    """K-Planes Model Config"""

    _target: Type = field(default_factory=lambda: KPlanesImportanceModel)
...
class KPlanesImportanceModel(Model):
    config: KPlanesImportanceModelConfig
    ...
    def populate_modules(self):
        ...
        # Using PDF sampler
        self.sampler_pdf = PDFSampler(num_samples=self.config.num_importance_samples, single_jitter=True, include_original=False)
