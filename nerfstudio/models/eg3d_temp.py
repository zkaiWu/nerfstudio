...
class Eg3dModelConfig(ModelConfig):
    ...
    """whether to use viewdirs in rgb decoding"""
...
class Eg3dModel(Model):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.appearance_dim = config.triplane_feature_dim
    ...
    def populate_modules(self):
        ...
        # samplers
        self.sampler_uniform = UniformSampler(num_samples=self.config.num_samples, single_jitter=False)
        self.sampler_pdf = PDFSampler(num_samples=self.config.num_importance_samples, single_jitter=False, include_original=False)
