...
ns-train eg3d --experiment-name llff_256_perframesr/flower \
...
# CUDA_VISIBLE_DEVICES=0 \
# ns-train eg3d --experiment-name llff_256_perframesr/fern \
#     --data="/data5/wuzhongkai/data/dreamfusion_data/llff/nerf_llff_data_256perframesr/fern" \
#     --pipeline.model.grid-base-resolution 256\
#     --pipeline.model.grid-feature-dim 32 \
#     --pipeline.model.num-samples 128 \
#     --pipeline.model.num-importance-samples 64 \
...
# CUDA_VISIBLE_DEVICES=1 \
# ns-train eg3d --experiment-name llff_256_perframesr/fortress \
#     --data="/data5/wuzhongkai/data/dreamfusion_data/llff/nerf_llff_data_256perframesr/fortress" \
#     --pipeline.model.grid-base-resolution 256\
#     --pipeline.model.grid-feature-dim 32 \
#     --pipeline.model.num-samples 128 \
#     --pipeline.model.num-importance-samples 64 \
...
# CUDA_VISIBLE_DEVICES=2 \
# ns-train eg3d --experiment-name llff_256_perframesr/horns \
#     --data="/data5/wuzhongkai/data/dreamfusion_data/llff/nerf_llff_data_256perframesr/horns" \
#     --pipeline.model.grid-base-resolution 256\
#     --pipeline.model.grid-feature-dim 32 \
#     --pipeline.model.num-samples 128 \
#     --pipeline.model.num-importance-samples 64 \
...
# ns-train eg3d --experiment-name llff_256_perframesr/leaves \
#     --data="/data5/wuzhongkai/data/dreamfusion_data/llff/nerf_llff_data_256perframesr/leaves" \
#     --pipeline.model.grid-base-resolution 256\
#     --pipeline.model.grid-feature-dim 32 \
#     --pipeline.model.num-samples 128 \
#     --pipeline.model.num-importance-samples 64 \
...
# CUDA_VISIBLE_DEVICES=0 \
# ns-train eg3d --experiment-name llff_256_perframesr/orchids \
#     --data="/data5/wuzhongkai/data/dreamfusion_data/llff/nerf_llff_data_256perframesr/orchids" \
#     --pipeline.model.grid-base-resolution 256\
#     --pipeline.model.grid-feature-dim 32 \
#     --pipeline.model.num-samples 128 \
#     --pipeline.model.num-importance-samples 64 \
...
# CUDA_VISIBLE_DEVICES=1 \
# ns-train eg3d --experiment-name llff_256_perframesr/room \
#     --data="/data5/wuzhongkai/data/dreamfusion_data/llff/nerf_llff_data_256perframesr/room" \
#     --pipeline.model.grid-base-resolution 256\
#     --pipeline.model.grid-feature-dim 32 \
#     --pipeline.model.num-samples 128 \
#     --pipeline.model.num-importance-samples 64 \
...
# CUDA_VISIBLE_DEVICES=2 \
# ns-train eg3d --experiment-name llff_256_perframesr/trex \
#     --data="/data5/wuzhongkai/data/dreamfusion_data/llff/nerf_llff_data_256perframesr/trex" \
#     --pipeline.model.grid-base-resolution 256\
#     --pipeline.model.grid-feature-dim 32 \
#     --pipeline.model.num-samples 128 \
#     --pipeline.model.num-importance-samples 64 \
